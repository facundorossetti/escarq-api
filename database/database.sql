...
CREATE TABLE merchant_orders(id INT PRIMARY KEY, items JSON, amount INT);
CREATE TABLE payments(id INT PRIMARY KEY, orderdata JSON, payer JSON, status VARCHAR(10), detail VARCHAR(10), amount INT);
